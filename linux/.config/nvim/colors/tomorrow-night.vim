...
let s:base8       = "#ffffff"
let s:fg          = "#c5c8c6"
"let s:fg_alt      = " doom-darken fg 0.4
...
let s:green       = "#b5bd68"
let s:blue        = "#81a2be"
let s:dark_blue   = "#41728e"
"let s:teal        = blue) ; FIXME replace with real teal
let s:magenta     = "#c9b4cf"
let s:violet      = "#b294bb"
let s:cyan        = "#8abeb7"
"let s:dark_cyan  (doom-darken cyan 0.4))

let s:dark_blue2  = "#5a7185"
let s:pink        = "#f0a0c0"
let s:debug        = "#FF00FF"
...
" #447799          rubyClass
" #c6b6fe          rubyIdentifier
" hi! link rubyConstant Type
" hi! link rubyFunction Function

" #c6b6fe          rubyInstanceVariable
" #7697d6          rubySymbol
...
" #540063          rubyRegexpDelimiter
" #dd0093          rubyRegexp
" #a40073          rubyRegexpSpecial

" #de5577          rubyPredefinedIdentifier
...
" endif
"         #232323 IndentGuidesOdd
"         #1b1b1b IndentGuidesEven
...
call s:H("VertSplit",      { "fg": s:base0 })
call s:H("Visual",         { "bg": s:base4 })
call s:H("Constant",       { "fg": s:orange })
call s:H("Function",       { "fg": s:blue }) " Function name & class methods
call s:H("Keyword",        { "fg": s:blue })
call s:H("Operator",       { "fg": s:fg })  " sizeof, +, *, etc
call s:H("Type",           { "fg": s:violet }) " int, long, char, etc
call s:H("String",         { "fg": s:green })
call s:H("Identifier",     { "fg": s:violet })  " Variable names
...
call s:H("Special",        { "fg": s:violet }) " this, Math class, etc
call s:H("Delimiter",      { "fg": s:fg })
" call s:H("StringDelimiter",{ "fg": s:dark_green2 })
call s:H("Structure",      { "fg": s:violet }) " struct, union, enum
call s:H("Statement",      { "fg": s:violet })
call s:H("PreProc",        { "fg": s:violet })
" call s:H("Character",      { "fg": "#ff00ff" })
call s:H("Float",          { "fg": s:orange, "gui": "bold" })
call s:H("Boolean",        { "fg": s:orange })
call s:H("Conditional",    { "fg": s:violet })   " if else switch etc
call s:H("Repeat",         { "fg": s:violet })   " for do while etc
call s:H("Label",          { "fg": s:violet })   " case, default ,etc
call s:H("Exception",      { "fg": s:violet })   " try catch throw
" call s:H("Include",        { "fg": s:debug })   " #include
" call s:H("Define",         { "fg": s:debug })   " #define
" call s:H("Macro",          { "fg": s:debug })   " same as define
" call s:H("PreCondit",      { "fg": s:debug })   " #if, #else, #endif
call s:H("StorageClass",   { "fg": s:violet }) " static, register, volatile, etc
" call s:H("Typedef",        { "fg": s:debug }) " interface names, etc
" call s:H("SpecialChar",    { "fg": s:debug })    " same as character?
" call s:H("Tag",            { "fg": s:debug })
" call s:H("SpecialComment", { "fg": s:debug })
" call s:H("Debug",          { "fg": s:debug })
" call s:H("Underlined",     { "fg": s:debug, "gui": "underline" })
...
" * Highlight Groups *
" ********************
call s:H("ColorColumn",  { "bg": s:base3 })
" call s:H("Conceal",      { "fg": s:debug })
...
call s:H("CursorColumn", { "bg": s:base3 })
call s:H("CursorLine",   { "bg": s:base3 })
call s:H("Directory",    { "fg": s:blue })
call s:H("ErrorMsg",     { "bg": s:bg, "fg": s:red })
call s:L("WinSeparator", "VertSplit")
call s:H("Folded",       { "bg": s:base4, "fg": s:fg })
call s:H("FoldColumn",   { "fg": s:fg })
call s:H("SignColumn",   { "fg": s:fg })
call s:H("LineNr",       { "fg": s:base4 })
call s:H("CursorLineNr", { "fg": s:blue, "gui": "bold" })
call s:H("MatchParen",   { "bg": s:base6, "fg": s:bg, "gui": "bold" })
call s:L("MoreMsg", "Special")
" call s:H("NonText",      { "fg": s:pink })
call s:H("NonText",      { "fg": s:grey })

call s:H("Pmenu",        { "bg": s:base0, "fg": s:fg })
call s:H("PmenuSel",     { "bg": s:base4 })
call s:H("PmenuSbar",    { "bg": s:base0 })
call s:H("PmenuThumb",   { "bg": s:base4 })

call s:H("Question",     { "fg": s:green })
call s:H("Search",       { "bg": s:blue, "fg": s:bg, "gui": "bold" })
call s:H("IncSearch",    { "bg": s:dark_blue2, "fg": s:fg, "gui": "bold" })
...
call s:H("DiffAdd",        { "bg": s:green, "fg": s:bg })
call s:H("DiffChange",     { "bg": s:dark_blue,   "fg": s:bg })
call s:H("DiffDelete",     { "bg": s:red,   "fg": s:bg })
call s:H("DiffText",       { "bg": s:blue,  "fg": s:bg })
...
" ******************************
call s:H("StatusLine",   { "bg": s:base0, "fg": s:fg })
call s:H("StatusLineNC", { "bg": s:bg, "fg": s:fg })
" call s:H('StatusLine             guifg=#ffffff guibg=#34373e')
call s:H("StatusLineNameError",   { "bg": s:base0, "fg": "#ff8484" })
call s:H("StatusLineNameWarning", { "bg": s:base0, "fg": "#ffcc5c" })
call s:H("StatusLine2",           { "bg": s:base0, "fg": s:fg })

call s:H("StatusLineModeNormal",   { "bg": s:green, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModePending",  { "bg": s:yellow, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeInsert",   { "bg": s:yellow, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeVisual",   { "bg": s:blue, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeVLine",    { "bg": s:blue, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeVBlock",   { "bg": s:blue, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeSelect",   { "bg": s:fg, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeSLine",    { "bg": s:fg, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeSBlock",   { "bg": s:fg, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeReplace",  { "bg": s:red, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeVReplace", { "bg": s:red, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeCommand",  { "bg": s:violet, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeEx",       { "bg": s:violet, "fg": s:base0, "gui": "bold" })
" call s:H("StatusLineModeMore",     { "bg": "#999999", "fg": s:base0, "gui": "bold" })
" call s:H("StatusLineModeConfirm",  { "bg": "#b7b842", "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeShell",    { "bg": s:base7, "fg": s:base0, "gui": "bold" })
call s:H("StatusLineModeTerminal", { "bg": s:base7, "fg": s:base0, "gui": "bold" })

call s:H("StatusLineGitAdd",    { "fg": s:green, "bg": s:base0 })
call s:H("StatusLineGitDelete", { "fg": s:red, "bg": s:base0 })
call s:H("StatusLineGitChange", { "fg": s:blue, "bg": s:base0 })

call s:H("StatusLineError",     { "fg": s:bg, "bg": "#ff8484" })
call s:H("StatusLineWarn",      { "fg": s:bg, "bg": "#ffcc5c" })
call s:H("StatusLineInfo",      { "fg": s:bg, "bg": "#53a7f3" })
call s:H("StatusLineHint",      { "fg": s:bg, "bg": "#4ccdd4" })

call s:H("WinBar",              { "fg": "#d3d7cf", "gui": "bold" })
call s:H("WinBarNC",            { "fg": "#999999", "gui": "bold" })
call s:H("WinBarLocation",      { "fg": "#999999" })

call s:H("WinBarNameError",     { "fg": "#ff8484", "gui": "bold" })
call s:H("WinBarNameWarning",   { "fg": "#ffcc5c", "gui": "bold" })
...
" Highlight the types
call s:H("CmpItemKindDefault",    { "fg": s:violet })
...
" **********************************
call s:H("IndentBlanklineChar",        { "fg": s:base4 })
call s:H("IndentBlanklineContextChar", { "fg": s:base6, "gui": "nocombine" })
...
call s:H("CommentPurple", { "fg": s:violet, "gui": "bold" })
...
call s:H("TelescopeSelection",      { "bg": s:base4, "fg": s:fg })
call s:H("TelescopeMatching",       { "fg": s:yellow, "gui": "bold" })
call s:H("TelescopeMultiSelection", { "fg": s:violet, "gui": "bold" })

" *****************************
" * easymotion/vim-easymotion *
" *****************************
call s:H("EasyMotionTargetDefault",        { "fg": s:yellow })
call s:H("EasyMotionShadeDefault",         { "fg": s:grey })

call s:H("EasyMotionTarget2FirstDefault",  { "fg": s:yellow })
call s:H("EasyMotionTarget2SecondDefault", { "fg": s:blue })

" call s:H("EasyMotionIncSearchDefault",     {})
" call s:H("EasyMotionIncCursorDefault",     {})
" call s:H("EasyMotionMoveHLDefault",        {})
