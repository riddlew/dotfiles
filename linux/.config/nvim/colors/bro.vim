...
let s:comment = "#77839b"
let s:nontext     = "#404040"
...
" let s:purple = "#da85ef"
let s:purple = "#efadff"
let s:dark_purple = "#c883e1"
let s:dark_purple2= "#700089"

let s:pink        = "#f0a0c0"
let s:debug        = "#FF00FF"

" let s:diffadd = { "bg": "#183300", "fg": "#C0E298" }
" let s:diffchange= { "bg": "#082D5A",   "fg": "#98BBE2" }
" let s:diffdelete = { "bg": "#500000",   "fg": "#E29898" }
" let s:difftext = { "bg": "#98BBE2",  "fg": s:bg }
" let s:diffheader = { "bg": "#98BBE2",  "fg": s:bg }
let s:diffadd = { "bg": s:nontext, "fg": s:green }
let s:diffchange= { "bg": s:nontext,   "fg": s:blue }
let s:diffdelete = { "bg": s:nontext,   "fg": s:dark_red }
let s:difftext = { "bg": s:dark_blue,  "fg": s:bg }
let s:diffheader = { "bg": s:dark_blue,  "fg": s:bg }
...
call s:H("Label",          { "fg": s:dark_blue })   " case, default ,etc
...
call s:H("CursorLine",   { "bg": s:test2 })
...
" call s:H("MatchParen",   { "bg": s:grey5, "fg": s:fg })
...
" call s:H("StatusLine",   { "bg": s:fg, "fg": s:bg })
" call s:H("StatusLineNC", { "bg": s:grey2, "fg": s:fg })

" call s:H("TabLine",      { "bg": s:grey2, "fg": s:fg })
...
" call s:H("StatusLineModeMore",     { "bg": "#999999", "fg": s:test3, "gui": "bold" })
" call s:H("StatusLineModeConfirm",  { "bg": "#b7b842", "fg": s:test3, "gui": "bold" })
...
" **************************
call s:H("GitGutterAdd",    { "fg": s:dark_green2 })
call s:H("GitGutterChange", { "fg": s:red })
call s:H("GitGutterDelete", { "fg": s:dark_blue })

" **********************
" * lewis6991/gitsigns *
" **********************
call s:H("GitSignsAdd",    { "fg": s:dark_green2 })
call s:H("GitSignsDelete", { "fg": s:red })
call s:H("GitSignsChange", { "fg": s:dark_blue })
...
call s:H("EasyMotionShadeDefault",         { "fg": s:grey5 })
...
" * jumper *
" **********
call s:H("JumperDirectory", { "fg": s:blue })
call s:H("JumperNormal", { "fg": s:fg })
