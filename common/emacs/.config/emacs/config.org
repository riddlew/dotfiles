...
- [[#custom-functions][Custom Functions]]
  ...
  - [[#add-trailing-space-to-all-headings-in-org-mode-except-ones-ending-with-tags][Add trailing space to all headings in org mode except ones ending with tags]]
  - [[#scroll-half-page][Scroll half page]]
...
- [[#other-hooks][Other Hooks]]
  ...
  - [[#add-trailing-spaces-to-org-mode-headings-on-save][Add trailing spaces to org mode headings on save]]
- [[#misc][Misc]]
...
- ~pixel-scroll-precision-mode~ does not work correctly with a mouse and still skips over large images. ~ultra-scroll~ did not fix it. It will only work if the window is resized at least once after opening emacs.
...
** Add trailing space to all headings in org mode except ones ending with tags 
...
Need to avoid adding it to lines ending with tags, as that can mess up ones that change on save like ~:toc:~.
...
Rebinds ~C-v~ / ~M-v~ to scroll half a page instead of a full page.
