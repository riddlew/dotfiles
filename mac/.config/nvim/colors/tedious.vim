...
" let s:nontext     = "#606060"
let s:nontext     = "#404040"
" let s:nontext     = "#353535"
...
" let s:diffadd = { "bg": s:nontext, "fg": s:bright_green }
let s:diffadd = { "bg": "#1b2f18" }
" let s:diffchange= { "bg": s:nontext,   "fg": s:very_blue }
let s:diffchange= { "bg": "#1c2b37" }
" let s:diffdelete = { "bg": s:nontext,   "fg": s:dark_red }
let s:diffdelete = { "fg": "#808080" }
" let s:difftext = { "bg": s:diff_blue,  "fg": s:fg }
let s:difftext = { "bg": s:diff_blue }
let s:diffheader = { "bg": s:very_blue,  "fg": s:bg }
...
" * nvim-tree *
" *************
call s:L("NvimTreeNormalFloat", "NvimTreeNormal")
